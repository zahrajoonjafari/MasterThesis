const df_227_0 = new (require('@comunica/logger-void').LoggerVoid)();
...
const df_531_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_531_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize_Bus_RdfSerialize
});
const df_531_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_hdt__1_0_0_config_sets_resolve_hdt_json_myQuadPatternResolver = new (require('@comunica/actor-rdf-resolve-quad-pattern-hdt').ActorRdfResolveQuadPatternHdt)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-init-sparql-hdt/^1.0.0/config/sets/resolve-hdt.json#myQuadPatternResolver',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern_Bus_RdfResolveQuadPattern
});
...
const df_523_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_523_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const df_523_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': 'df_523_1',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_myRdfSparqlSerializer = new (require('@comunica/actor-sparql-serialize-rdf').ActorSparqlSerializeRdf)({
  ...
  'mediatorMediaTypeCombiner': df_531_0,
  'mediatorMediaTypeFormatCombiner': df_531_1,
...
const urn_comunica_sparqlinit = new (require('@comunica/actor-init-sparql').ActorInitSparql)({
  ...
  'mediatorSparqlSerializeMediaTypeCombiner': df_523_0,
  'mediatorSparqlSerializeMediaTypeFormatCombiner': df_523_1,
...
const urn_comunica_my = ({
  ...
  https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql_hdt__1_0_0_config_sets_resolve_hdt_json_myQuadPatternResolver,

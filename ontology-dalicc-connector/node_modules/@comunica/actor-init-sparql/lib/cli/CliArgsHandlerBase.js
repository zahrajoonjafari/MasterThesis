...
`;
        ...
        // Define context
        if (args.context) {
            Object.assign(context, JSON.parse(fs_1.existsSync(args.context) ? fs_1.readFileSync(args.c, 'utf8') : args.context));
        }
        ...
        // Define the base IRI
        if (args.baseIRI) {
            context[context_entries_1.KeysInitSparql.baseIRI] = args.baseIRI;
        }
        // Define lenient-mode
        if (args.lenient) {

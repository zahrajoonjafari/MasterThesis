const df_317_0 = new (require('@comunica/logger-void').LoggerVoid)(undefined);
...
const df_757_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const df_743_0 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': 'df_743_0',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const df_743_1 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': 'df_743_1',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
